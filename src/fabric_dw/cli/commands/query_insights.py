"""Query Insights sub-commands for the fabric-dw CLI."""
...
@click.group("query-insights")
def query_insights_group() -> None:
    """Inspect Query Insights DMVs on Fabric warehouses and SQL Analytics Endpoints."""


# ---------------------------------------------------------------------------
# Shared options (applied as decorators on each sub-command)
# ---------------------------------------------------------------------------
...
@query_insights_group.command("request-history")
...
@query_insights_group.command("session-history")
@click.argument("workspace", required=False, default=None)
@click.argument("warehouse", required=False, default=None)
@_LIMIT_OPTION
@_SINCE_OPTION
...
@query_insights_group.command("frequent")
@click.argument("workspace", required=False, default=None)
@click.argument("warehouse", required=False, default=None)
@_LIMIT_OPTION
@_SINCE_OPTION
...
@query_insights_group.command("long-running")
@click.argument("workspace", required=False, default=None)
@click.argument("warehouse", required=False, default=None)
@_LIMIT_OPTION
@_SINCE_OPTION
...
@query_insights_group.command("pool-insights")
@click.argument("workspace", required=False, default=None)
@click.argument("warehouse", required=False, default=None)
@_LIMIT_OPTION
@_SINCE_OPTION
